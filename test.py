...
# judicious.seed("8dc33b88-61aa-88b4-650d-6152989831d3")
...
def get_numbers():
    df3 = pd.read_csv('https://necdetgurkangfmt.s3.us-east-2.amazonaws.com/csv/numbers.csv')
...
def get_faces():
    df1_face = pd.read_csv('https://necdetgurkangfmt.s3.us-east-2.amazonaws.com/csv/face_url%2B2%2B(1)%2B(4)%2B(2).csv')
...
def face_training(number):
    if number == 1:
        df_face = pd.read_csv('https://necdetgurkangfmt.s3.us-east-2.amazonaws.com/csv_folder/30_short_gfmt_training.csv')
    elif number == 2:
        df_face = pd.read_csv('https://necdetgurkangfmt.s3.us-east-2.amazonaws.com/csv_folder/37_short_gfmt_training.csv')
    elif number == 3:
        df_face = pd.read_csv('https://necdetgurkangfmt.s3.us-east-2.amazonaws.com/csv_folder/44_short_gfmt_training.csv')
    elif number == 4:
        df_face = pd.read_csv('https://necdetgurkangfmt.s3.us-east-2.amazonaws.com/csv_folder/51_short_gfmt_training.csv')
    elif number == 5:
        df_face = pd.read_csv('https://necdetgurkangfmt.s3.us-east-2.amazonaws.com/csv_folder/58_short_gfmt_training.csv')
    elif number == 6:
        df_face = pd.read_csv('https://necdetgurkangfmt.s3.us-east-2.amazonaws.com/csv_folder/65_short_gfmt_training.csv')
    elif number == 7:
        df_face = pd.read_csv('https://necdetgurkangfmt.s3.us-east-2.amazonaws.com/csv/face_url%2B2%2B(1)%2B(4)%2B(2).csv')
    else:
        return None
...
print(post_results, pre_results, training_results)
